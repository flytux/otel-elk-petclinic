...
opentelemetry_javaagent_version=2.16.0
...
java -Dotel.metric.export.interval=500 -Dotel.bsp.schedule.delay=500 -Dotel.exporter.otlp.endpoint=http://192.168.122.239:30318 -javaagent:${jar} -jar ./target/rolldice.jar
